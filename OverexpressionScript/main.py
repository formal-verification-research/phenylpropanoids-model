...
results = subprocess.run(["prism", "../pathway_curcumin.sm", "../curcuminRewards.csl", "-const E_TAL=0.18529842311041933:0.18529842311041933", "-sim", "-simsamples 100", "-const T=172800", "-v", "-cuddmaxmem 110g"])
print(results)
